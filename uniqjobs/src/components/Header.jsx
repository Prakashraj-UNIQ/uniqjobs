        ...
        <div className="hidden lg:block border-gray-800 border-l pl-4">
          <ul className="flex space-x-5 text-black">
            <li><a href="https://www.facebook.com/share/1H6HomtGnP/" target="_blank" className="hover:text-primary-600  transform">
                <svg className="w-9 h-9 fill-black hover:fill-blue-600 transition duration-300 ease-in-out "
            ...
            <li><a href="https://twitter.com/Uniqtechs?t=Uq2VphiMgcDiTzDgQRuYQg&s=08" target="_blank">
              <svg className="w-9 h-9 p-2 bg-black rounded-full fill-white hover:bg-sky-600 transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 32 32">
            ...
            <li><a href="https://t.me/uniqtechnologies" target="_blank">
                <svg className="w-9 h-9 fill-black hover:fill-sky-400 transition duration-300 ease-in-out" viewBox="0 0 32 32"
