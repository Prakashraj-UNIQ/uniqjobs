  ...
  return (
    <>
     <Banner/>
      ...
      <div className="py-8 text-center bg-[#f2f2f2]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 px-2 sm:px-10 lg:px-20 gap-4 bg-[#f2f2f2] py-10">
        <CourseCard
          courseRoute={"courses"}
      ...
      <div className="py-4 sm:py-8 text-center bg-white">
        <h1 className="px-2 text-black text-3xl lg:text-5xl fold-primary font-black">
          Our Training &
