...
import interview1 from "../assets/images/interview-1.jpg";
import interview2 from "../assets/images/interview-2.jpg";
import interview3 from "../assets/images/interview-3.jpg";

const videos = {
  tab1: [
    { id: "nnQ8HN9vhQQ", image: interview2 },
    { id: "cNBhe0aJ9cw", image: interview3 },
  ],
  tab2: [
    { id: "gPvVasNVUyM", image: interview1 },
    { id: "gPvVasNVUyM", image: interview1 },
  ],
};
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="block lg:flex border-b border-gray-300">
        <button
          className={`py-2 pr-2 font-primary font-semibold text-gray-600 border-b-2 sm:pr-4 hover:text-red-600 focus:outline-none ${
            activeTab === "tab1"
        ...
        <button
          className={`px-4 py-2 font-primary font-semibold text-gray-600 border-b-2 hover:text-red-600 focus:outline-none ${
            activeTab === "tab2"
              ? "border-red-600 text-red-600"
              : "border-transparent"
          }`}
      ...
      <div className="mt-4">
        <div
          className="grid grid-cols-1 lg:grid-cols-2 gap-4 slide-in-drop"
